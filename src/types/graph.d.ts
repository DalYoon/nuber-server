...
export interface Mutation {
  ...
  SkipPhoneVerification: SkipPhoneVerificationResponse;
}
...
export interface SkipPhoneVerificationMutationArgs {
  phoneNumber: string;
}
...
export interface SkipPhoneVerificationResponse {
  ok: boolean;
  error: string | null;
}
